...
dropdown = dcc.Dropdown(['Egypt', 'South Africa', 'Mozambique','Tanzania','Sudan'], value=['Egypt', 'South Africa', 'Mozambique','Tanzania','Sudan'], 
                        clearable=False, multi=True, style ={'padding': '15px', 'backgroundColor': 'white', 'color': 'black'})
...
def update_bar_chart(countries): 
    ...
    fig3 = fig3.update_layout(
        plot_bgcolor="white", paper_bgcolor="white", font_color="black", geo_bgcolor="white")
